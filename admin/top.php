...
$currStr = $_SERVER['REQUEST_URI'];
 ...
 //prx($currArr);
  ...
  $cur_path=$curArr[count($currArr)-1];
...
}elseif($cur_path=='category.php' || $cur_path=='add_category.php'){
...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="assets/c ss/materialdesignicons.min.css">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="delivery_boy.php">
              <i class="mdi mdi-view-headline menu-icon"></i>
              <span class="menu-title">Delivery_Boy</span>
            </a>
          </li>
